...
const TextSlide = ({ text }) => {
  return (
    <>
      <div className="flex items-center justify-center text-7xl max-w-[1920px] h-fit">
        <h1 className={`tracking-tight text-xl md:text-3xl lg:text-5xl text-transparent bg-clip-text bg-gradient-to-t from-[#d9d9d9] to-[#f6f6f6] whitespace-nowrap px-3`}>
          {text}
        </h1>
        <svg
