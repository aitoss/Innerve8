...
export default function Footer() {
  // const [sphereSize, setSphereSize] = useState(Math.min(window.innerWidth, window.innerHeight) / 350);
  ...
  return (
    ...
    //           Presented By:
    //         </h1>
    //         <div className="w-full z-100 flex justify-center md:h-[300px] lg:justify-start">
    //           <div className="">
    //             <Canvas
    //             // orthographic={true}
    //             // camera={{zoom: 50 }}
    ...
    //         <div className="w-full flex justify-center">
    //           <h1 className="text-white text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-5xl">Innerve to Innovate</h1>
    //         </div>
    ...
    //         <h1 className="text-white text-center text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-5xl">Venue</h1>
    //         <div className="w-full flex justify-center">
    //           <div className="w-3/4 max-w-[600px] h-48  bg-white rounded-md mt-5 items-center"></div>
    //         </div>
    //       </div>
    //     </div>
    //   </div>
