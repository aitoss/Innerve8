        ...
        <div className="lower-footer bg-[#0f0f0f]">
          <div className="px-4 py-6 md:flex md:items-center md:justify-between max-w-screen-xl mx-auto">
            ...
            <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
              ...
              >
                <svg className="w-4 h-4 " aria-hidden="ture" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <a href="https://twitter.com/innerve_8"
                className="text-gray-400 hover:text-gray-900 dark:hover:text-white"
              >
                <svg className="w-4 h-4" viewBox="0 0 25 25" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
