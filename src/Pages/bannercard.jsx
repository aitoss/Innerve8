            ...
            <section className=" md:px-10 mx-8 mb-8">
                <div className="banner flex flex-col gap-8 p-12 max-w-screen-xl" style={{margin: 'auto'}}>
                    <div className="banner-sub w-full flex justify-between items-center">
                        ...
                        <div className="btn group flex items-center justify-center gap-3 border border-[#212121] rounded-full p-2 pl-5 cursor-pointer" onClick={handleEmailClick}>
                            <a className="banner-subheading font-[400] text-[#212121] hover:text-[#212121] hover:cursor-pointer transition-all -z-1" >aitoss@aitpune.edu.in</a>
