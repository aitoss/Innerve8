    ...
    <div className="absolute top-10 left-0 right-0 overflow-hidden">
      ...
      >
        <div className="w-[1990px] flex gap-4 items-center justify-center">
          <h1 className=" tracking-tight text-5xl text-transparent bg-clip-text bg-gradient-to-t from-[#121212] to-[#515151] whitespace-nowrap">
            10lac+ Prize pool
          </h1>
          <svg
...
const Heading = () => {
  return (
    <div className="text-center xl:block hidden tracking-[10px] font-medium text-[200px] sticky text-gradient-to-b from-white via-white to-[rgba(55, 47, 47, 0.5)]">
      <motion.div
